...
import { Phone, Mic, Headphones, Star, Zap, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="bg-gray-800/30 border-b border-gray-700 py-6">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="relative">
            {/* Profile Card */}
            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-2xl p-6 border-2 border-purple-500/50 backdrop-blur-sm">
